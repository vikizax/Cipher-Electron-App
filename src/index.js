...
const init = () => {
  ...
  playfairDecrypt.addEventListener("click", async e => {
    ...
    const plainTextResult = document.querySelector(
      "#plain-text-result-playfair"
    );
  ...
  performanceAction.addEventListener("click", async e => {
    ...
    const performanceKeyPlayFair = document.querySelector(
      "#performance-key-pf"
    );
